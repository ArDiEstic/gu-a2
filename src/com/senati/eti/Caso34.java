...
Scanner sc = new Scanner(System.in);
		...
		if (n1 == n2 && n1 == n3 && n3 == n4)
			...
			estado = "El cuarto número " + n4 + " es el mayor";
		else if (n1 == n2 && n3 < n1 && n4 < n2)
			estado = "El primer y segundo número " + n1 + " son los mayores";
		else if (n1 == n3 && n2 < n1 && n4 < n3)
			estado = "El primer y tercer número " + n1 + " son los mayores";
		else if (n1 == n4 && n3 < n1 && n2 < n4)
			estado = "El primer y cuarto número " + n1 + " son los mayores";
		else if (n2 == n3 && n1 < n2 && n4 < n3)
			estado = "El segundo y tercer número " + n2 + " son los mayores";
		else if (n2 == n4 && n3 < n2 && n1 < n4)
			estado = "El segundo y cuarto número " + n2 + " son los mayores";
		else if (n3 == n4 && n1 < n3 && n2 < n4)
			estado = "El tercer y cuarto número " + n3 + " son los mayores";
		else if (n1 == n2 && n1 == n3 && n4 < n3)
			estado = "El primer, segundo y tercer número " + n1 + " son los mayores";
		else if (n1 == n2 && n1 == n4 && n3 < n4)
			estado = "El primer, segundo y cuarto número " + n1 + " son los mayores";
		else if (n1 == n4 && n1 == n3 && n2 < n3)
			estado = "El primer, tercer y cuarto número " + n1 + " son los mayores";
		else if (n2 == n3 && n2 == n4 && n1 < n4)
			estado = "El segundo, tercer y cuarto número " + n2 + " son los mayores";
